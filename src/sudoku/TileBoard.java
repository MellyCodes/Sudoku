...
public class TileBoard extends AnchorManager {
    ...
    /**
     * Puts the move in a temp variable, clears it for the next play and returns
     * the temp move
     *
     * @return
     */
    ...
    /**
     * Accept the tile onto the board in its proper position and resets
     * isDraggable to false (can't move the tile once it's accepted).
     *
     * @param move
     * @param tile
     */
     ...
     * @param hideBoard
     */
    public void hideBoard(boolean hideBoard) {
