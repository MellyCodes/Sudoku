...
public class Button extends ImageEntity {
    ...
    private ArrayList<String> imagePaths = new ArrayList<String>() {
        {
            add("resources/buttons/menuButtonUp.png");
            add("resources/buttons/menuButtonDown.png");
            add("resources/buttons/menuButtonDisabled.png");
            add("resources/buttons/keyButtonUp.png");
            add("resources/buttons/keyButtonDown.png");
            add("resources/buttons/keyButtonDisabled.png");
            add("resources/buttons/hubButtonUp.png");
            add("resources/buttons/hubButtonDown.png");
            add("resources/buttons/hubButtonDisabled.png");
            add("resources/buttons/gameButtonUp.png");
            add("resources/buttons/gameButtonDown.png");
            add("resources/buttons/gameButtonDisabled.png");
        }
    };
