...
public class Tile extends ImageEntity implements MouseMotionListener {
    ...
    private ArrayList<String> imagePaths = new ArrayList<String>() {
        {
            add("resources/TileOne.png");
            add("resources/TileTwo.png");
            add("resources/TileThree.png");
            add("resources/TileFour.png");
            add("resources/TileFive.png");
            add("resources/TileSix.png");
            add("resources/TileSeven.png");
            add("resources/TileEight.png");
            add("resources/TileNine.png");
            add("resources/TileOneWhite.png");
            add("resources/TileTwoWhite.png");
            add("resources/TileThreeWhite.png");
            add("resources/TileFourWhite.png");
            add("resources/TileFiveWhite.png");
            add("resources/TileSixWhite.png");
            add("resources/TileSevenWhite.png");
            add("resources/TileEightWhite.png");
            add("resources/TileNineWhite.png");
        }
    };
    ...
    public void setIsBoardTile(boolean isBoardTile) {
